package com.startersapi.exceptionhandler;
...
public class ApiExceptionHandler extends ResponseEntityExceptionHandler{
	...
	public ResponseEntity<Object> handleEmptyResultDataAccessExcception (EmptyResultDataAccessException ex, WebRequest request) {
	...
	public ResponseEntity<Object> handleDataIntegrityViolationException(DataIntegrityViolationException ex, WebRequest request){
		String msgUsuario = message.getMessage("recurso.operacao-nao-permitida", null, LocaleContextHolder.getLocale());
	...
	private List<Erro> criarListaDeErros (BindingResult bindingResult){
		...
		for(FieldError fieldError : bindingResult.getFieldErrors()) {		
			String msgUsuario = message.getMessage(fieldError, LocaleContextHolder.getLocale());
